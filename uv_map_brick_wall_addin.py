...
class ShaderNodeuv_map_brick_wall(bpy.types.NodeCustomGroup):
    ...
    def createNodetree(self, name) :
        ...
        self.addNode('ShaderNodeMath', { 'name':'Node16' ,'operation':'DIVIDE' })
        self.addNode('ShaderNodeMath', { 'name':'Node17' ,'inputs[1].default_value':0.5 ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node18' ,'inputs[1].default_value':0.5 ,'operation':'ROUND' })
        self.addNode('ShaderNodeMath', { 'name':'Node19' ,'inputs[1].default_value':0.5 ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node20' ,'operation':'ROUND' })
        self.addNode('ShaderNodeMath', { 'name':'Node21' ,'operation':'GREATER_THAN' })
        self.addNode('ShaderNodeMath', { 'name':'Node22' ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node23' ,'operation':'ABSOLUTE' })
        self.addNode('ShaderNodeMath', { 'name':'Node24' ,'inputs[1].default_value':0.000001 ,'operation':'GREATER_THAN' })
        self.addNode('ShaderNodeMath', { 'name':'Node25' ,'operation':'GREATER_THAN' })
        self.addNode('ShaderNodeMath', { 'name':'Node26' ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node27' ,'operation':'ABSOLUTE' })
        self.addNode('ShaderNodeMath', { 'name':'Node28' ,'inputs[1].default_value':0.000001 ,'operation':'GREATER_THAN' })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node29'  })
        self.addNode('ShaderNodeMath', { 'name':'Node30' ,'operation':'MODULO' })
        self.addNode('ShaderNodeMath', { 'name':'Node31' ,'operation':'LESS_THAN' })
        self.addNode('ShaderNodeMath', { 'name':'Node32' ,'operation':'ADD' })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node33'  })
        ...
        self.addNode('ShaderNodeMath', { 'name':'Node36' ,'operation':'GREATER_THAN' })
        self.addNode('ShaderNodeMath', { 'name':'Node37' ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node38' ,'operation':'ABSOLUTE' })
        self.addNode('ShaderNodeMath', { 'name':'Node39' ,'inputs[1].default_value':0.000001 ,'operation':'GREATER_THAN' })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node40'  })
        ...
        self.addNode('ShaderNodeMath', { 'name':'Node49' ,'operation':'MULTIPLY' })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node50'  })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node51'  })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node52'  })
        self.addNode('ShaderNodeMixRGB', { 'name':'Node53'  })
        self.addNode('ShaderNodeMath', { 'name':'Node54' ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node55' ,'operation':'ADD' })
        self.addNode('ShaderNodeMath', { 'name':'Node56' ,'operation':'DIVIDE' })
        self.addNode('ShaderNodeMath', { 'name':'Node57' ,'inputs[1].default_value':0.5 ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node58' ,'inputs[1].default_value':0.5 ,'operation':'ROUND' })
        self.addNode('ShaderNodeMath', { 'name':'Node59' ,'inputs[1].default_value':0.5 ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node60' ,'operation':'ROUND' })
        self.addNode('ShaderNodeCombineXYZ', { 'name':'Node61'  })
        self.addNode('ShaderNodeMath', { 'name':'Node62' ,'operation':'ADD' })
        self.addNode('ShaderNodeMath', { 'name':'Node63' ,'operation':'MULTIPLY' })
        self.addNode('ShaderNodeMath', { 'name':'Node64' ,'operation':'SUBTRACT' })
        self.addNode('ShaderNodeMath', { 'name':'Node65' ,'operation':'MULTIPLY' })
        ...
        self.innerLink('nodes["GroupInput"].outputs[6]', 'nodes["Node21"].inputs[0]')
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node21"].inputs[1]')
        self.innerLink('nodes["Node21"].outputs[0]', 'nodes["Node22"].inputs[0]')
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node22"].inputs[1]')
        self.innerLink('nodes["Node22"].outputs[0]', 'nodes["Node23"].inputs[0]')
        self.innerLink('nodes["Node23"].outputs[0]', 'nodes["Node24"].inputs[0]')
        self.innerLink('nodes["GroupInput"].outputs[7]', 'nodes["Node25"].inputs[0]')
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node25"].inputs[1]')
        ...
        self.innerLink('nodes["Node24"].outputs[0]', 'nodes["Node29"].inputs[1]')
        self.innerLink('nodes["Node28"].outputs[0]', 'nodes["Node29"].inputs[2]')
        self.innerLink('nodes["Node20"].outputs[0]', 'nodes["Node30"].inputs[0]')
        self.innerLink('nodes["GroupInput"].outputs[7]', 'nodes["Node30"].inputs[1]')
        self.innerLink('nodes["Node30"].outputs[0]', 'nodes["Node31"].inputs[0]')
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node31"].inputs[1]')
        self.innerLink('nodes["GroupInput"].outputs[7]', 'nodes["Node32"].inputs[0]')
        self.innerLink('nodes["Node30"].outputs[0]', 'nodes["Node32"].inputs[1]')
        self.innerLink('nodes["Node31"].outputs[0]', 'nodes["Node33"].inputs[0]')
        self.innerLink('nodes["Node30"].outputs[0]', 'nodes["Node33"].inputs[1]')
        self.innerLink('nodes["Node32"].outputs[0]', 'nodes["Node33"].inputs[2]')
        ...
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node36"].inputs[1]')
        self.innerLink('nodes["Node36"].outputs[0]', 'nodes["Node37"].inputs[0]')
        self.innerLink('nodes["Node7"].outputs[0]', 'nodes["Node37"].inputs[1]')
        ...
        self.innerLink('nodes["GroupInput"].outputs[8]', 'nodes["Node40"].inputs[1]')
        self.innerLink('nodes["Node11"].outputs[0]', 'nodes["Node40"].inputs[2]')
        self.innerLink('nodes["GroupInput"].outputs[3]', 'nodes["Node41"].inputs[0]')
        self.innerLink('nodes["Node40"].outputs[0]', 'nodes["Node41"].inputs[1]')
        self.innerLink('nodes["Node20"].outputs[0]', 'nodes["Node42"].inputs[0]')
        self.innerLink('nodes["GroupInput"].outputs[6]', 'nodes["Node42"].inputs[1]')
        self.innerLink('nodes["Node42"].outputs[0]', 'nodes["Node43"].inputs[0]')
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node43"].inputs[1]')
        self.innerLink('nodes["GroupInput"].outputs[6]', 'nodes["Node44"].inputs[0]')
        ...
        self.innerLink('nodes["Node8"].outputs[0]', 'nodes["Node48"].inputs[1]')
        self.innerLink('nodes["Node41"].outputs[0]', 'nodes["Node49"].inputs[0]')
        self.innerLink('nodes["GroupInput"].outputs[5]', 'nodes["Node49"].inputs[1]')
        self.innerLink('nodes["Node48"].outputs[0]', 'nodes["Node50"].inputs[0]')
        self.innerLink('nodes["Node49"].outputs[0]', 'nodes["Node50"].inputs[1]')
        self.innerLink('nodes["Node7"].outputs[0]', 'nodes["Node50"].inputs[2]')
        self.innerLink('nodes["Node29"].outputs[0]', 'nodes["Node51"].inputs[0]')
        self.innerLink('nodes["GroupInput"].outputs[3]', 'nodes["Node51"].inputs[1]')
        self.innerLink('nodes["Node41"].outputs[0]', 'nodes["Node51"].inputs[2]')
        self.innerLink('nodes["Node29"].outputs[0]', 'nodes["Node52"].inputs[0]')
        self.innerLink('nodes["Node7"].outputs[0]', 'nodes["Node52"].inputs[1]')
        self.innerLink('nodes["Node50"].outputs[0]', 'nodes["Node52"].inputs[2]')
        self.innerLink('nodes["Node29"].outputs[0]', 'nodes["Node53"].inputs[0]')
        self.innerLink('nodes["Node6"].outputs[0]', 'nodes["Node53"].inputs[1]')
        self.innerLink('nodes["Node36"].outputs[0]', 'nodes["Node53"].inputs[2]')
        self.innerLink('nodes["Node11"].outputs[0]', 'nodes["Node54"].inputs[0]')
        self.innerLink('nodes["Node53"].outputs[0]', 'nodes["Node54"].inputs[1]')
        self.innerLink('nodes["Node13"].outputs[0]', 'nodes["Node55"].inputs[0]')
        self.innerLink('nodes["Node52"].outputs[0]', 'nodes["Node55"].inputs[1]')
        ...
        self.innerLink('nodes["Node20"].outputs[0]', 'nodes["Node61"].inputs[1]')
        self.innerLink('nodes["Node7"].outputs[0]', 'nodes["Node61"].inputs[2]')
        self.innerLink('nodes["Node13"].outputs[0]', 'nodes["Node62"].inputs[0]')
        self.innerLink('nodes["Node52"].outputs[0]', 'nodes["Node62"].inputs[1]')
        self.innerLink('nodes["Node51"].outputs[0]', 'nodes["Node63"].inputs[0]')
        self.innerLink('nodes["Node60"].outputs[0]', 'nodes["Node63"].inputs[1]')
        self.innerLink('nodes["Node62"].outputs[0]', 'nodes["Node64"].inputs[0]')
        self.innerLink('nodes["Node63"].outputs[0]', 'nodes["Node64"].inputs[1]')
        self.innerLink('nodes["GroupInput"].outputs[4]', 'nodes["Node65"].inputs[0]')
        self.innerLink('nodes["Node20"].outputs[0]', 'nodes["Node65"].inputs[1]')
        self.innerLink('nodes["Node15"].outputs[0]', 'nodes["Node66"].inputs[0]')
        self.innerLink('nodes["Node65"].outputs[0]', 'nodes["Node66"].inputs[1]')
        self.innerLink('nodes["Node64"].outputs[0]', 'nodes["Node67"].inputs[0]')
        self.innerLink('nodes["Node66"].outputs[0]', 'nodes["Node67"].inputs[1]')
        self.innerLink('nodes["Node7"].outputs[0]', 'nodes["Node67"].inputs[2]')
        self.innerLink('nodes["Node67"].outputs[0]', 'nodes["GroupOutput"].inputs[0]')
        self.innerLink('nodes["Node61"].outputs[0]', 'nodes["GroupOutput"].inputs[1]')
        self.innerLink('nodes["Node51"].outputs[0]', 'nodes["GroupOutput"].inputs[2]')
        self.innerLink('nodes["GroupInput"].outputs[4]', 'nodes["GroupOutput"].inputs[3]')
        self.innerLink('nodes["Node54"].outputs[0]', 'nodes["GroupOutput"].inputs[4]')
